      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          <div className="order-1 lg:order-2">
            <ScrollReveal>
              <p className="section-eyebrow">Why {APP_NAME}</p>
              <h2 className="mt-3 text-3xl font-bold tracking-tight sm:text-4xl">
                Your trusted partner for lending operations
              </h2>
              <p className="mt-6 text-lg leading-relaxed text-muted-foreground">
                We built {APP_NAME} because generic tools don&apos;t understand
                Lot Title loans, investor splits, or the pace of a busy lending
                desk. You get software that speaks your language.
              </p>
            </ScrollReveal>
