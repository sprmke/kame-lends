...
- Owner: edit, delete, **Contract Details** (⋯ menu → `max-w-5xl` modal: signing status, full contract setup tabs from edit form, **Save contract** + **Download contract**), payment tools.
