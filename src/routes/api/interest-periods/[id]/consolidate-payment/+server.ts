...
import { interestPeriods, loanInvestors, receivedPayments } from '$lib/server/db/schema';
...
export const POST: RequestHandler = async (event) => {
	...
	try {
		...
		await db.delete(receivedPayments).where(eq(receivedPayments.interestPeriodId, periodId));
