...
export function formatSensitiveText(value: string | number | null | undefined): string {
	return maskOrFormat(
...
export function formatSensitiveCount(value: number | string | null | undefined): string {
	return maskOrFormat(
		isSensitiveDataHidden(),
		value,
		(v) => {
