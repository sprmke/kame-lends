...
export function applyContractCustomization(
  ...
  const title =
    typeof customization.contractTitle === "string"
      ? customization.contractTitle.trim()
      : "";
  const collateral =
...
export function areContractCustomizationsEqual(
  ...
  const normalize = (customization: ContractCustomization) => ({
    ...customization,
    lenderSignaturesIncluded: sortRecordKeys(
      customization.lenderSignaturesIncluded,
    ),
