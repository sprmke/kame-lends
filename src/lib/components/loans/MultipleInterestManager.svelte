...
<div class="space-y-3">
	<Tabs.Root value={mode} onValueChange={(v) => handleModeChange(v as 'single' | 'multiple')}>
		...
		<Tabs.Content value="single" class="mt-3 space-y-3">
		...
		<Tabs.Content value="multiple" class="mt-3 space-y-3">
			...
			{#if totals}
				<div class="grid grid-cols-2 gap-2.5 rounded-md border bg-muted/50 p-3 md:grid-cols-4">
					<div>
