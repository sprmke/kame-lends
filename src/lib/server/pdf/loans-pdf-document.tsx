  ...
  <View
    style={[
      styles.badge,
      {
        ...
        border: `1 solid ${getTypeColor(type)}`,
      },
    ]}
  >
...
const PeriodStatusBadge = ({ status }: { status: InterestPeriodStatus }) => (
  <View
    style={[styles.badge, { backgroundColor: getPeriodStatusColor(status) }]}
  >
...
const LoanCard = ({
  ...
  if (showInvestors && loan.loanInvestors.length > 0)
    visibleSectionKeys.push("investors");
  ...
  return (
    <View
      style={[styles.loanCard, isLast ? { marginBottom: 0 } : {}]}
      break={!isFirst}
    >
          ...
          return (
            <View style={sectionStyle("financial_summary")} wrap={false}>
              ...
              <View style={[styles.financialGrid, { marginTop: 6 }]}>
                ...
                >
                  <Text style={styles.financialCellLabel}>
                    Balance Remaining
                  </Text>
                  <Text
                    style={[
                  ...
                  <View style={{ paddingHorizontal: 10, paddingBottom: 8 }}>
                    ...
                    <View style={styles.periodTable}>
                      <View style={styles.periodTableHeader}>
                        <Text
                          style={[styles.periodTableHeaderCell, { flex: 0.6 }]}
                        >
                          #
                        </Text>
                        <Text
                          style={[styles.periodTableHeaderCell, { flex: 2 }]}
                        >
                          Due Date
                        </Text>
                        <Text
                          style={[styles.periodTableHeaderCell, { flex: 1.5 }]}
                        >
                          Rate / Amount
                        </Text>
                        <Text
                      ...
                      {[...li.interestPeriods]
                        ...
                        .map((period, pIdx) => {
                          const isLastPeriod =
                            pIdx === li.interestPeriods!.length - 1;
                          ...
                          return (
                            ...
                            >
                              ...
                              <Text
                                style={[styles.periodTableCell, { flex: 2 }]}
                              >
                                {formatDateForPDF(period.dueDate)}
                              </Text>
                              <Text
                                style={[styles.periodTableCell, { flex: 1.5 }]}
                              >
                                {rateDisplay}
                              </Text>
                  ...
                  <View style={{ paddingHorizontal: 10, paddingBottom: 8 }}>
                    ...
                    <View style={styles.paymentsTable}>
                      ...
                      {visiblePayments.map((payment, rIdx) => {
                        const isLastPayment =
                          rIdx === visiblePayments.length - 1;
                        return (
                          <View
                            key={payment.id}
                            style={
                              isLastPayment
                                ? styles.paymentsTableRowLast
      ...
      {showFreeLot && hasFreeLot && (
        <View style={sectionStyle("free_lot")}>
          ...
          <View style={styles.freeLotRow}>
            <Text style={styles.freeLotValue}>
              {loan.freeLotSqm?.toLocaleString()}
            </Text>
  ...
  return (
    ...
    >
      <Page size="A4" style={styles.page}>
        ...
        {data.length > 0 && (
          <View
            style={[styles.totalsCard, { marginTop: 0, marginBottom: 16 }]}
            wrap={false}
          >
            ...
            <View
              style={[
                styles.totalsGrid,
                {
                  paddingTop: 0,
                  paddingBottom: 12,
                  borderTop: `0.5 solid #dbeafe`,
                },
              ]}
            >
              <View style={[styles.totalsCell, { flex: 2 }]}>
                <Text style={[styles.totalsCellLabel, { marginTop: 8 }]}>
                  By Status
                </Text>
                <View
                  style={{
