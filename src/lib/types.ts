...
export type InterestPeriodStatus =
  "Pending" | "Incomplete" | "Completed" | "Overdue";
...
export interface WitnessSigningInvitation {
  id: number;
  partyRole: string;
...
export interface WitnessWithLoans extends Witness {
  signingInvitations?: WitnessSigningInvitation[];
}
